...
namespace Star5
{
    public partial class ADIDrinks : Form
    {
        ...
        void BindGridView()
        {
            ...
            string query = "select * from I_drinks";
        ...
        {
            SqlConnection con = new SqlConnection(cs);
            string query = "insert into I_drinks values (@id,@name,@price,@image)";
        ...
        {
            SqlConnection con = new SqlConnection(cs);
            string query = "update I_drinks set id=@id,name=@name,price=@price,image=@image where id=@id";
            SqlCommand cmd = new SqlCommand(query, con);
            cmd.Parameters.AddWithValue("@id", textBox1.Text);
            cmd.Parameters.AddWithValue("@name", textBox2.Text);
            cmd.Parameters.AddWithValue("@price", textBox3.Text);
        ...
        {
            SqlConnection con = new SqlConnection(cs);
            string query = "delete from I_drinks where id=@id";
            SqlCommand cmd = new SqlCommand(query, con);
            cmd.Parameters.AddWithValue("@id", textBox1.Text);
        ...
        private void ADIDrinks_Load(object sender, EventArgs e)
        {
