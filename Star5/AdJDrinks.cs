...
namespace Star5
{
    public partial class AdJDrinks : Form
    {
        ...
        void BindGridView()
        {
            ...
            string query = "select * from J_drinks";
        ...
        {
            SqlConnection con = new SqlConnection(cs);
            string query = "insert into J_drinks values (@id,@name,@price,@image)";
        ...
        {
            SqlConnection con = new SqlConnection(cs);
            string query = "update J_drinks set id=@id,name=@name,price=@price,image=@image where id=@id";
            SqlCommand cmd = new SqlCommand(query, con);
            cmd.Parameters.AddWithValue("@id", textBox1.Text);
            cmd.Parameters.AddWithValue("@name", textBox2.Text);
            cmd.Parameters.AddWithValue("@price", textBox3.Text);
        ...
        {
            SqlConnection con = new SqlConnection(cs);
            string query = "delete from J_drinks where id=@id";
            SqlCommand cmd = new SqlCommand(query, con);
            cmd.Parameters.AddWithValue("@id", textBox1.Text);
        ...
        private void AdJDrinks_Load(object sender, EventArgs e)
        {
