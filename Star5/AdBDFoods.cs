...
namespace Star5
{
    public partial class AdBDFoods : Form
    {
        ...
        {
            SqlConnection con = new SqlConnection(cs);
            string query = "insert into BD_Food values (@id,@name,@price,@image)";
        ...
        {
            SqlConnection con = new SqlConnection(cs);
            string query = "update BD_Food set id=@id,name=@name,price=@price,image=@image where id=@id";
            SqlCommand cmd = new SqlCommand(query, con);
            cmd.Parameters.AddWithValue("@id", textBox1.Text);
            cmd.Parameters.AddWithValue("@name", textBox2.Text);
            cmd.Parameters.AddWithValue("@price", textBox3.Text);
        ...
        {
            SqlConnection con = new SqlConnection(cs);
            string query = "delete from BD_Food where id=@id";
            SqlCommand cmd = new SqlCommand(query, con);
            cmd.Parameters.AddWithValue("@id", textBox1.Text);
